...
class GetItemGrad(Function):
    ...
    def forward(self, gy):
        xp = cyeld.cuda.get_array_module(gy)
...
class BroadcastTo(Function):
    ...
    def forward(self, x):
        self.x_shape = x.shape
        xp = cyeld.cuda.get_array_module(x)
...
# =============================================================================
from cyeld.functions_conv import conv2d
from cyeld.functions_conv import deconv2d
from cyeld.functions_conv import conv2d_simple
from cyeld.functions_conv import im2col
from cyeld.functions_conv import col2im
from cyeld.functions_conv import pooling_simple
from cyeld.functions_conv import pooling
from cyeld.functions_conv import average_pooling
from cyeld.core import add
from cyeld.core import sub
from cyeld.core import rsub
from cyeld.core import mul
from cyeld.core import div
from cyeld.core import neg
from cyeld.core import pow