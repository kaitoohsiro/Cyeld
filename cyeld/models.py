import numpy as np
from cyeld import Layer
import cyeld.functions as F
import cyeld.layers as L
from cyeld import utils
...
# =============================================================================
class VGG16(Model):
    WEIGHTS_PATH = 'https://github.com/koki0702/cyeld-models/releases/download/v0.1/vgg16.npz'
...
# =============================================================================
class ResNet(Model):
    WEIGHTS_PATH = 'https://github.com/koki0702/cyeld-models/releases/download/v0.1/resnet{}.npz'
